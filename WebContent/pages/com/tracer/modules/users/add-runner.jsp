  ...
  <head>
    <script>
      $(document).ready(function() {
        ...
        $.validator.addMethod("passregex", function(value, element, regexp) {
          var re = new RegExp(regexp);
          return this.optional(element) || re.test(value);
        });
      ...
      function checkTypeofActivity() {
        ...
        if(method == 'edit'){
          ...
          $(".bottombuttons").empty();
          $(".bottombuttons").html('<div class="updatedistbtn"> <input id="user_runner_update_btn" type="submit" value="Update" class="btn btn-primary" onclick="showAllPanels();"/> <a id="user_runner_update_cancel_hl" href="<%=request.getContextPath()%>/user.do?method=showManageUsersPage" title="Cancel" class="btn btn-primary"><bean:message key="label.cancel" /></a> </div>');
        ...
        <div id="titleheading">
          ...
          <div id="titleheadingbar">
            <div class="navtitle">
              ...
              <bean:message key="label.users" /> / <bean:message key="label.add.runner" />
            </div>
          </div>
          ...
          <div class="divstyleleft">
            ...
            <div class="divcontent1" id="panel">
              <div class="left-content">
                <label><bean:message key="label.user.name" />*</label>
                <html:text property="userName" styleId="userName" maxlength="32"/>
                <label><bean:message key="label.hub" /></label>
              ...
              <div class="left-content rightinputs">
                ...
                <label>
                  <bean:message key="label.reporting.to" />*</label>
            ...
            <div class="divcontent5" id="panel1">
              <div class="left-content">
                ...
                <label><bean:message key="label.city" /></label>
                <html:text property="city" styleId="city_tf" maxlength="50" />
                <label><bean:message key="label.district" /></label>
                <html:text property="district" styleId="district_tf" maxlength="50" />
              </div>
              <div class="left-content rightinputs">
                <label><bean:message key="label.state" /></label>
                ...
                <label><bean:message key="label.pincode" /></label>
            ...
            <div class="divcontent7" id="panel5">
              ...
              <div class="left-content rightinputs">
                <label><bean:message key="label.office.phone.number" />*</label>
                ...
                <label><bean:message key="label.imei.number" />*</label>
          ...
          <div class="divstyleright">
            ...
            <div class="divcontent2" id="panel2">
              <div class="left-content">
                <div>
                  <label><bean:message key="label.gender" />*</label>
              ...
              <div class="left-content rightinputs">
                ...
                <span id='dateOfAnniversarySpan' class='hide'>
                  <label><bean:message key="label.date.of.anniversary" /></label>
          ...
          <div class="bottombuttons">
            <input id="user_runner_add_save_btn" type="submit" value="Save" class="btn btn-primary" onclick="showAllPanels();"/>
