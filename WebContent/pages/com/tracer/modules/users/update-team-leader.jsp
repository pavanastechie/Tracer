...
<html>
  ...
  <body onload="checkTypeofActivity()">
    <div class="clear"></div>
    <div id="form-content">
      <html:form styleId="updateUserForm" action="/user.do?method=updateTeamLeader" enctype="multipart/form-data">
        <div id="titleheading">
          <div class="navtitle1">
            <bean:message key="label.update.team.leader" />
          </div>
          <br />
          <div id="titleheadingbar">
            <div class="navtitle">
              <i class="fa fa-user"></i>
              <bean:message key="label.users" /> / <bean:message key="label.update.team.leader" />
            </div>
          </div>
          ...
          <div class="bottombuttons">
            <html:submit styleId="user_tsm_update_btn" styleClass="btn btn-primary" value="Update" onclick="showAllPanels();">
