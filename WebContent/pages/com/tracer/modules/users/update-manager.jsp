...
<html>
  ...
  <body onload="checkTypeofActivity()">
    <div class="clear"></div>
    <div id="form-content">
      <html:form styleId="updateUserForm" action="/user.do?method=updateManager" enctype="multipart/form-data">
        <div id="titleheading">
          <div class="navtitle1">
          ...
          <div class="bottombuttons">
            <html:submit styleId="user_manager_update_btn" styleClass="btn btn-primary" value="Update" onclick="showAllPanels();"><i class="fa fa-check-square-o"></i></html:submit>
            <a id="user_manager_add_cancel_btn" href="<%=request.getContextPath()%>/user.do?method=showManageUsersPage" title="Cancel" class="btn btn-primary"><bean:message key="label.cancel" /></a>
          </div>
        </div>
