...
<script type="text/javascript">
  ...
  $(document).ready(function(){
	  ...
	  // Top Runners
        ...
        requestData["hubId"] = "";
        displayTopRunnersReport("ChartDiv4",contextPath,requestData);
      requestData = {};
    ...
    // Top Distributors
        ...
        requestData["regionId"] = "";
        requestData["hubId"] = "";
        displayTopDistributorsReport("ChartDiv3",contextPath,requestData);
      requestData = {};
      ...
      // Top Zones
        ...
        requestData["noOfRecords"] = "";
        requestData["circleId"] = "";
        displayTopZonesReport("ChartDiv1",contextPath,requestData);
      requestData = {};
      ...
      // Top Hubs
        ...
        requestData["circleId"] = "";
        requestData["regionId"] = "";
        displayTopHubsReport("ChartDiv2",contextPath,requestData);
      requestData = {};
  ...
  <div id="form-content">
    <div id="titleheading">
      <div class="navtitle1">Zone Manager Dashboard</div><div class="dashboard-error">Please Select Four Reports</div>
      <br />
      <div id="titleheadingbar">
        <div class="navtitle"><i class="fa fa-dashboard"></i> Zone Manager Dashboard</div>
<%--         <div id="nav2">
          <ul>
            <li><a href="#"><i
