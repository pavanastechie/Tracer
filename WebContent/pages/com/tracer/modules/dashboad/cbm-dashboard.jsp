...
<script type="text/javascript">
  ...
  <div id="form-content">
    <div id="titleheading">
      <div class="navtitle1">Circle Manager Dashboard</div><div class="dashboard-error"></div>
      <br />
      <div id="titleheadingbar">
        <div class="navtitle"><i class="fa fa-dashboard"></i> Circle Manager Dashboard</div>
<%--         <div id="nav2">
          <ul>
            <li><a href="#"><i
