...
var contextPath = "<%=Constants.TRACER_RWS_URL%>";
    $(document).ready(function(){
        ...
        tsmId ="<%=Constants.TEAM_LEADER%>";
         if(roleId == cbmId || roleId == saId ) {
           ...
           $('.asm-top-hubs').remove();
        	 ...
        	 zoneId = "<%=request.getSession().getAttribute(Constants.ASSIGNED_ZONE_ID)%>";
       	  $('.sa-top-hubs').remove();
             $('.rbm-top-hubs').remove();
             $('.zbm-top-hubs').remove();
         } 
      $('#topRunner').click(function() {
        ...
        $("#top-hubs-table").find("tr:gt(0)").remove();
        var reportsData = {};
        var isValid = true;
        ...
        if(isValid) {
        <%-- var url = "<%=request.getContextPath()%>/js/jChartFX/data/top-hubs-data.json"; --%>
          ...
          title.setText("Top Hubs based on CAFs collected");
          titles.add(title);
          ...
          promise.done(function (responseData) {
            if(responseData.errorMessage != "undefined") {
               ...
               for(var i= 0; i<responseData.topHubs.length;i++) {
                  var html = '<tr><td>'+responseData.topHubs[i].hubName+'</td><td>'+responseData.topHubs[i].cafCount+'</td><td>'+responseData.topHubs[i].zoneName+'</td></tr>';
                  $('#top-hubs-table').append(html);
               }
          	  } else {
...
<div id="form-content">
  <div id="titleheading">
    <div class="navtitle1"><bean:message key="label.reports.topHubs"/></div>
    <br />
    <div id="titleheadingbar">
      <div class="navtitle"><i class="fa fa-clipboard"></i>  <bean:message key="label.reports"/> /  <label><bean:message key="label.reports.topHubs"/></label></div>
      <div id="nav3">
       <%long roleId = 0L;
    ...
    <div class="divheading10">
     <bean:message key="label.reports.topHubs"/>
    </div>
    <div class="reportContent innerAddBlock sa-top-hubs" id="panel5">
      <div class="displayTable">
       ...
       <div class="displayTableRow">
        ...
        <div class="reportContent innerAddBlock rbm-top-hubs" id="panel5">
      <div class="displayTable">
        <div class="displayTableRow">
          <div class="displayTableCell reportsTableCellDrpdown" id="regionsListContainer">
           <div class="reportsLabel"><bean:message key="label.reports.regionName"/></div>
       ...
       <div class="displayTableRow">
        ...
        <div class="reportContent innerAddBlock zbm-top-hubs" id="panel5">
      <div class="displayTable">
        <div class="displayTableRow">
          <div class="displayTableCell reportsTableCellDrpdown" id="zonesListContainer">
           <div class="reportsLabel"><bean:message key="label.reports.zoneName"/></div>
      ...
      <div class="reportContent innerAddBlock asm-top-hubs" id="panel5">
      <div class="displayTable">
       <div class="displayTableRow">
          <div class="displayTableCell reportsTableCellTxtbox">
           <div class="reportsLabel"><bean:message key="label.reports.dateFrom"/></div>
    ...
    <div id="reportcontent" class="hide-reports-table">
      <table id="top-hubs-table" width="100%" align="center" cellpadding="0" cellspacing="0"
