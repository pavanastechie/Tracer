...
<html>
  <head>
    <script type="text/javascript">
      ...
      function getZonePerformanceReport(){
          var extensions = {
          ...
          $.extend($.fn.dataTableExt.oStdClasses , extensions);
            $("#upload-onlineCaf-table").dataTable({
                ...
                "bProcessing": false,
                "sAjaxDataProp":"",
              "sAjaxSource": "reports.do?method=getZonePerformanceReport",
                "aoColumns": [
                            {"aTargets": [ 0 ], "mDataProp": "date", "bSortable": true, "sClass": "upload-onlineCaf-row-mobileNo"},
                            {"aTargets": [ 1 ], "mDataProp": "zoneName", "bSortable": true, "sClass": "upload-onlineCaf-row-orderNumber" },
                            {"aTargets": [ 2 ], "mDataProp": "hubName", "bSortable": true, "sClass": "upload-onlineCaf-row-orderNumber" },
                            {"aTargets": [ 3 ], "mDataProp": "runnerName", "bSortable": true, "sClass": "upload-onlineCaf-row-distributorName" },
                            {"aTargets": [ 4 ], "mDataProp": "distributorName", "bSortable": true, "sClass": "upload-onlineCaf-row-distributorName" },
                            {"aTargets": [ 5 ], "mDataProp": "ofscCode", "bSortable": true, "sClass": "upload-onlineCaf-row-status" },
                            {"aTargets": [ 6 ], "mDataProp": "scheduleTime", "bSortable": true, "sClass": "upload-onlineCaf-row-status" },
                            {"aTargets": [ 7 ], "mDataProp": "visitedTime", "bSortable": true, "sClass": "upload-onlineCaf-row-status" },
                            {"aTargets": [ 8 ], "mDataProp": "cafsCollected", "bSortable": true, "sClass": "upload-onlineCaf-row-status" },
                        ],
                        "oTableTools": {
                        ...
                        "aButtons": [
                                     {
                                         "sExtends": "csv",
                                         "sFileName": "Zone_Performance_Details_Report.csv",
                                         "mColumns": [0,1,2,3,4,5,6,7,8]
                                     },
                                     {
                                         "sExtends": "xls",
                                         "sFileName": "Zone_Performance_Details_Report.xls",
                                         "mColumns": [0,1,2,3,4,5,6,7,8]
                                     },
                                     {
                                         "sExtends": "pdf",
                                         "sFileName": "Zone_Performance_Details_Report.pdf",
                                         "mColumns": [0,1,2,3,4,5,6,7,8]
                                     },
                                 ]
                     },
        ...
        function showZonePerformanceReportPage() {
          var zoneId = document.forms[0].zoneId.value;
          if(zoneId > 0) {
            document.forms[0].action ="reports.do?method=showZonePerformanceReportPage";
            document.forms[0].submit();
          } else {
        	  $('#report-error-msg').text('Please select Zone');
            return false;
          }
        }
  ...
  <body onload="getZonePerformanceReport()">
    <div class="clear"></div>
    <html:form action="/reports.do">
      ...
      <div class="navtitle"><i class="fa fa-clipboard"></i>  <bean:message key="label.reports"/> /  <label>Zone Performance Report</label></div>
      <div id="nav3">
      <ul>
        <li>
          ...
          <div class="upload-divcontent" id="panel">
            ...
            <div class="search-input-details-div">
              <bean:message key="label.reports.zoneName"/>
                <html:select  property="zoneId" styleClass="performance-report-dd" styleId="zonesList">
             ...
             <bean:message key="label.reports.dateTo"/>
              ...
              <input type="button" value="GO" class="btn btn-primary gobtn" id="gobtn"  onclick="showZonePerformanceReportPage()" />
            </div>
          </div>
        </div>
            ...
            <table id="upload-onlineCaf-table" class="records-page">
              <thead>
                <tr class="manage-distributors-content-headings datatable-header">
                  ...
                  <th class="upload-onlineCaf-row-orderNumber">Zone</th>
