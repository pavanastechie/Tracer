...
<script type="text/javascript">
    $(document).ready(function(){
      var roleId ="<%=request.getSession().getAttribute(Constants.ROLE_ID)%>";
      var saId ="<%=Constants.SYSTEM_ADMIN%>";
      if(roleId != saId) {
    	  $('.attendance').remove();
      }
...
<div id="form-content">
<div id="titleheading">
  <div class="navtitle1">Admin reports dashboard</div>
  <br />
  <div id="titleheadingbar">
    <div class="navtitle"><i class="fa fa-clipboard"></i>  Reports /  <label>Admin reports dashboard</label></div>
    </div>
      ...
      <div class="report-users">
        ...
        <div class="report-box1 clsbox5 hubs">
          ...
          <div id="text-data">Top Hubs</div>
                ...
                <div class="report-box1 clsblack attendance">
          <div class="users clsblack">
            <i class="fa fa-clock-o"></i>
          </div>
          <div id="text-data">Daily Attendance of Runners</div>
          <!-- <div class="info">
