...
var contextPath = "<%=Constants.TRACER_RWS_URL%>";
    $(document).ready(function(){
     ...
     tsmId ="<%=Constants.TEAM_LEADER%>";
         ...
         $('.rbm-top-runners').remove();
         $('.zbm-top-runners').remove();
         $('.asm-top-runners').remove();
         $('.tsm-top-runners').remove();
         } else if(roleId == rbmId) {
       	  $('.sa-top-runners').remove();
             $('.zbm-top-runners').remove();
             $('.asm-top-runners').remove();
             $('.tsm-top-runners').remove();
      ...
      $('#topRunner').click(function() {
        ...
        $("#top-runners-table").find("tr:gt(0)").remove();
        var reportsData = {};
        var isValid = true;
        ...
        if(isValid) {
           <%--  var url = "<%=request.getContextPath()%>/js/jChartFX/data/funnelchart-data.json"; --%>
           var url = contextPath+"api/reports/top/runners/get";
            ...
            td.setText("Top runners by CAFs collection");
            ...
            promise.done(function (responseData) {
              if(responseData.errorMessage != "undefined") {
            	  if(responseData.topRunners != null) {
                ...
                chart1.getAnimations().getLoad().setEnabled(true);
                 ...
                 for(var i= 0; i<responseData.topRunners.length;i++) {
                    var html = '<tr><td>'+responseData.topRunners[i].name+'</td><td>'+responseData.topRunners[i].cafCount+'</td><td>'+responseData.topRunners[i].hubName+'</td></tr>';
                    $('#top-runners-table').append(html);
                 }
            	  } else {
     ...
     $('#circlesList').change(function() {
    	  //document.reportForm.reportName.value = "TopRunners";
...
<div class="clear"></div>
<html:form action="/reports.do" styleId="reportsForm">
<div id="form-content">
  <div id="titleheading">
    <div class="navtitle1"><bean:message key="label.reports.topRunners"/></div>
    <br />
    <div id="titleheadingbar">
      <div class="navtitle"><i class="fa fa-clipboard"></i>  <bean:message key="label.reports"/> /  <label><bean:message key="label.reports.topRunners"/></label></div>
      <div id="nav3">
       <%long roleId = 0L;
    ...
    <div class="divheading10" id="flip5">
     <bean:message key="label.reports.topRunners"/><i class="fa fa-chevron-down downarrow"></i>
    </div>
    <div class="reportContent innerAddBlock sa-top-runners" id="panel5">
      <div class="displayTable">
       ...
       <div class="displayTableRow">
        ...
        <div class="reportContent innerAddBlock rbm-top-runners" id="panel5">
      <div class="displayTable">
        <div class="displayTableRow">
          <div class="displayTableCell reportsTableCellDrpdown" id="regionsListContainer">
           <div class="reportsLabel"><bean:message key="label.reports.regionName"/></div>
     ...
     <div class="reportContent innerAddBlock zbm-top-runners" id="panel5">
      <div class="displayTable">
        <div class="displayTableRow">
          <div class="displayTableCell reportsTableCellDrpdown" id="zonesListContainer">
           <div class="reportsLabel"><bean:message key="label.reports.zoneName"/></div>
       ...
       <div class="displayTableRow">
        ...
        <div class="reportContent innerAddBlock asm-top-runners" id="panel5">
      <div class="displayTable">
       <div class="displayTableRow">
          <div class="displayTableCell reportsTableCellDrpdown" id="hubsListContainer">
           <div class="reportsLabel"><bean:message key="label.reports.hubName"/></div>
        ...
        <div class="reportContent innerAddBlock tsm-top-runners" id="panel5">
      <div class="displayTable">
       <div class="displayTableRow">
          <div class="displayTableCell reportsTableCellTxtbox">
           <div class="reportsLabel"><bean:message key="label.reports.dateFrom"/></div>
    ...
    <div id="reportcontent" class="hide-reports-table">
      <table id="top-runners-table" width="100%" align="center" cellpadding="0" cellspacing="0"
