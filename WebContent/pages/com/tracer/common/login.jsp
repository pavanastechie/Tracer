...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <script type="text/javascript">
      ...
      function areValidCredentials() {
        ...
        if(userName != null && userName.length > 0) {
          ...
          if(password != null && password.length > 0) {
            document.loginForm.method.value = 'areValidCredentials'; 
            document.loginForm.action = "<%=request.getContextPath()%>/login.do";
            document.loginForm.submit();
          } else {
            var html='<span <i class="fa fa-exclamation-triangle"></i></span> <span style="font-size:16px; font-family: Open Sans; font-weight: 400;" >Please provide a Password.</span>';
            $('#loginerrorid').append(html).show();
            document.loginForm.password.focus();
            return false;
          }
        } else {
          var html='<span <i class="fa fa-exclamation-triangle"></i></span> <span style="font-size:16px; font-family: Open Sans; font-weight: 400;"> Please provide User Name.</span>';
           $('#loginerrorid').append(html).show();
      ...
      {  
       ...
       $('#userPwd input[type="password"]').val('');
  ...
  <body id="body" onload="setFocus()">
    <html:form action="/login.do">
      ...
      <div class="row">
        <div class="col-lg-offset-4 col-lg-4 col-lg-offset-4 login" style="margin-top: -550px;">
          ...
          <div class="panel panel-default">
            <div class="panel-heading">
              <h3 class="panel-title tup"><i class="fa fa-sign-in"></i> Login</h3>
            </div>
            <div class="panel-body">
              <p>
                Your Workforce management portal to Track, Manage,
                Review and Report your Agent, Distributor, Hub, Zone, Region and Circle's performance.
              </p>
              <div class="input-group" id="userId">
                <span class="input-group-addon"> <i class="fa fa-user"></i></span>
                <html:text property="userName" styleClass="form-control" maxlength="32" onkeydown="submitForm(event);" styleId="login_username_tf"/> 
              </div>
              <div class="input-group" id="userPwd">
                <span class="input-group-addon"><i class="fa fa-unlock-alt"></i></span>
                <html:password property="password" maxlength="20" styleClass="form-control" styleId="login_password_tf" onkeydown="submitForm(event);"/>
              </div>
               <a href="/Tracer/forgotpassword.do?method=showForgotPasswordPage" style="color: white;">Forgot your password?</a>
            </div>
            <div class="panel-footer">
              <button type="submit" class="btn btn-primary" onclick="return areValidCredentials();" id="login_submit_btn"><i class="fa fa-sign-in"></i> &nbsp;Login
              </button>
            </div>
          </div>
        </div>
