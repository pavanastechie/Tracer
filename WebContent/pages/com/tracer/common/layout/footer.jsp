...
<div class="footer">
	...
	<div class="footer-main">
		<div class="footer">
			<p>
				TraceR<sup>&copy;</sup> SCI IT Solutions (P) Ltd. 2014
			</p>
		</div>
...
<div class="modal fade" id="termsofuse" tabindex="-1" role="dialog"
	...
	<div class="modal-dialog modelfooter">
		<div class="modal-content">
			...
			<div class="modal-body footercontent" style="font-size: 14px;"> <p>SCI Group and its affiliates (&ldquo;SCI Group&rdquo; or &ldquo;we&rdquo;) is committed to protecting the privacy of the personally-identifiable information that we collect from users of our Web sites (the &ldquo;Site&rdquo;). The scope of SCI Group&rsquo;s commitment is detailed in this Privacy Policy. By submitting information, you agree to SCI Group&rsquo;s use of such information as described herein. Please see our Terms of Use for more information about our on-line policies in general.</p>
