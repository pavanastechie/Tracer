  ...
  <head>
    ...
    <script type="text/javascript">
      ...
      function areValidCredentials() {
        var userName = document.forgotpasswordFrom.userName.value;
        $('#loginerrorid').empty();
        $('#messsages1').empty();
        if(userName != null && userName.length > 0) {
          document.forgotpasswordFrom.method.value = 'isExists'; 
          document.forgotpasswordFrom.action = "<%=request.getContextPath()%>/forgotpassword.do";
          document.forgotpasswordFrom.submit();
             ...
             document.forgotpasswordFrom.userName.focus();
             return false;
          }
        ...
        <div class="col-lg-offset-4 col-lg-4 col-lg-offset-4 login" style="margin-top: -550px;">
          ...
          <div class="panel panel-default">
            <div class="panel-heading">
              <h3 class="panel-title tup"><i class="fa fa-sign-in"></i> Forgot Password?</h3>
            </div>
            <div class="panel-body">
              <p>
                Please enter the username to get Password
              </p>
            ...
            <div class="panel-footer">
              <button type="submit" class="btn btn-primary" onclick="return areValidCredentials();" id="login_submit_btn"><i class="fa fa-sign-in"></i> &nbsp;Submit
              </button>
            </div>
          </div>
        </div>
